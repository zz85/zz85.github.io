...
I'm Joshua and this is my playground.
...
- GitHub: [@zz85](https://github.com/zz85)
...
- **[threejs-path-flow](https://github.com/zz85/threejs-path-flow)** - Mesh deformation and curve-following animations
...
- **[random-sketches](https://github.com/zz85/random-sketches)** - Collection of creative coding experiments
- **[bezierlights](https://github.com/zz85/bezierlights)** - Bezier curve lighting effects

## 🦀 Systems Programming & Performance

### eBPF & Profiling
- **[profile-bee](https://github.com/zz85/profile-bee)** - eBPF-based CPU profiler in Rust
- **[papaya-tools](https://github.com/zz85/papaya-tools)** - Collection of eBPF/aya utilities
- **[mem-tools](https://github.com/zz85/mem-tools)** - Experimental memory analysis tools

### Networking & Protocols
- **[packet_radar](https://github.com/zz85/packet_radar)** - Real-time network packet analysis and visualization
- **[tcc-trace](https://github.com/zz85/tcc-trace)** - TCP congestion control tracing tool
- **[quic-initial-degreaser](https://github.com/zz85/quic-initial-degreaser)** - QUIC packet cleanup utility
- **[shoeprint](https://github.com/zz85/shoeprint)** - Network diagnostics (traceroute, ping, mtr, whois)
...
- **[silly-ai](https://github.com/zz85/silly-ai)** - Voice-first local AI assistant running on macOS
